...
title ) }}" />
                ...
                <div class="form-group">
                    <label for="catergory_id-field">Catergory_id</label>
                    <input class="form-control" type="text" name="catergory_id" id="catergory_id-field" value="{{ old('catergory_id', $topic->catergory_id ) }}" />
                </div> 
                <div class="form-group">
